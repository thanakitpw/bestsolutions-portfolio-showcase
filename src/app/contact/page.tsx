  ...
  return (
    <main className="flex min-h-screen w-full flex-col bg-black pt-32 px-6 md:px-12">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
        <div>
          <h1 className="font-playfair text-5xl md:text-7xl text-white mb-8">Contact Us</h1>
          <p className="text-white/70 text-lg mb-12">
            Experience exceptional service. Reach out to our concierge team to schedule a test drive, request a brochure, or inquire about our exclusive models.
          </p>

          <div className="space-y-8">
            <div>
              <h3 className="text-[#D4AF37] uppercase tracking-widest text-xs font-semibold mb-2">Concierge Service</h3>
              <p className="text-white/80">+1 (800) 555-0199</p>
            </div>
            <div>
              <h3 className="text-[#D4AF37] uppercase tracking-widest text-xs font-semibold mb-2">Email</h3>
              <p className="text-white/80">concierge@luxury-auto.com</p>
            </div>
            <div>
              <h3 className="text-[#D4AF37] uppercase tracking-widest text-xs font-semibold mb-2">Headquarters</h3>
              <p className="text-white/80">100 Luxury Avenue<br/>Beverly Hills, CA 90210</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="firstName" className="text-white/60 text-xs uppercase tracking-widest">First Name</label>
                <input 
                  type="text" 
                  id="firstName" 
              ...
              <div className="space-y-2">
                <label htmlFor="lastName" className="text-white/60 text-xs uppercase tracking-widest">Last Name</label>
                <input 
                  type="text" 
                  id="lastName" 
                  className="w-full bg-black border border-white/10 text-white px-4 py-3 focus:outline-none focus:border-[#D4AF37] transition-colors"
            ...
            <div className="space-y-2">
              <label htmlFor="interest" className="text-white/60 text-xs uppercase tracking-widest">Model of Interest</label>
              <select 
                id="interest" 
              ...
              >
                <option value="s-class">The S-Class</option>
                <option value="g-class">The G-Class</option>
